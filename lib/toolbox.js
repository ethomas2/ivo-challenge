...
const describeHelperSchema = z.object({
  type: z.literal("describeHelper"),
  helperName: z.string().describe("The name of the helper file"),
});
describeHelperSchema.type = "describeHelper";
...
const describeHelperTool = {
  ...
  schema: describeHelperSchema,
  handler: async ({ helperName }) => {
    return await describeHelper(helperName);
  },
};
describeHelperTool.type = "describeHelper";
